              ...
              <v-divider></v-divider>
                    ...
                    >
                        ...
                        <template v-slot:item.actions="{ item }">
                            ...
                            <div v-if='item.status=="PENDING RSA APPROVER" || item.status=="PR DECLINED BY RSA APPROVER"'>
                                <v-tooltip bottom>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-icon
                                        small
...
<script>
    ...
    methods: {
        ...
        ApprovePR(){
                ...
                axios.post('/ApprovePRRSAApprover', this.selectedForPRChanges )
                .then(response =>{
        ...
        DeclinePR(){
                axios.post('/DeclinePRRSAApprover', this.selectedForPRChanges )
                .then(response =>{
                    console.log(response.data)
