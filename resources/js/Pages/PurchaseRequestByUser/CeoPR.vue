              ...
              <v-divider></v-divider>
                    ...
                    >
                        ...
                        <template v-slot:item.actions="{ item }">
                            ...
                            <div v-if='item.status=="PENDING CEO APPROVAL" || item.status=="PR DECLINED BY CEO"'>
                                <v-tooltip bottom>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-icon
                                        small
...
<script>
    ...
    methods: {
        ...
        ApprovePR(){
                ...
                axios.post('/ApprovePRCEO', this.selectedForPRChanges )
                .then(response =>{
        ...
        DeclinePR(){
                axios.post('/DeclinePRCEO', this.selectedForPRChanges )
                .then(response =>{
