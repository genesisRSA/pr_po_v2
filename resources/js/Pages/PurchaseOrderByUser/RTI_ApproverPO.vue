              ...
              <v-divider></v-divider>
                    ...
                    >
                        ...
                        <div class='d-flex'>
                            ...
                            <div v-if='item.status=="PENDING RTI APPROVER"'>
                                <v-tooltip bottom>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-icon
                                        small
                            ...
                            <div v-if='item.status=="PENDING RTI APPROVER" || item.status=="PO APPROVED"'>
                                <v-tooltip bottom>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-icon
                                        small
...
<script>
    ...
    methods: {
        ...
        ApprovePO(){
                axios.post('/ApprovePORTIApprover', this.selectedForPOChanges )
                .then(response =>{
        ...
        DeclinePO(){
                axios.post('/DeclinePORTIApprover', this.selectedForPOChanges )
                .then(response =>{
