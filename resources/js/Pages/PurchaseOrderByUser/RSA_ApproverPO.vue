              ...
              <v-divider></v-divider>
                    ...
                    >
                        ...
                        <div class='d-flex'>
                            ...
                            <div v-if='item.status=="PENDING RSA APPROVER"'>
                                <v-tooltip bottom>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-icon
                                        small
                            ...
                            <div v-if='item.status=="PENDING RSA APPROVER" || item.status=="PO APPROVED"'>
                                <v-tooltip bottom>
                                <template v-slot:activator="{ on, attrs }">
                                    <v-icon
                                        small
...
<script>
    ...
    methods: {
        ...
        ApprovePO(){
                axios.post('/ApprovePORSAApprover', this.selectedForPOChanges )
                .then(response =>{
        ...
        DeclinePO(){
                axios.post('/DeclinePORSAApprover', this.selectedForPOChanges )
                .then(response =>{
