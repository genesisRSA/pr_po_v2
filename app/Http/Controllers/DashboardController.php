    ...
    public function getMyCostinglist(){
      ...
      ->map(function($query){
          return [
              ...
              'item_subcat' => isset($query->item_due_id) ? (isset(SubCategoryItem::where('id',isset(ItemList::where('id',$query->item_due_id)->first()->sub_category_item_id) ? ItemList::where('id',$query->item_due_id)->first()->sub_category_item_id : null)->first()->subcategory_name) ? SubCategoryItem::where('id',isset(ItemList::where('id',$query->item_due_id)->first()->sub_category_item_id) ? ItemList::where('id',$query->item_due_id)->first()->sub_category_item_id : null)->first()->subcategory_name : null):'N/A',
